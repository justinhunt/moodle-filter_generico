...
/**
 * Unit test for the filter_generico
 *
...
global $CFG;
require_once($CFG->dirroot . '/filter/generico/filter.php'); // Include the code to test


class filter_generico_testcase extends basic_testcase {
    ...
    function test_convert_urls_into_links($text, $correctresult) {
        $testablefilter = new testable_filter_generico();
 ...
 */
class testable_filter_generico extends filter_generico {
